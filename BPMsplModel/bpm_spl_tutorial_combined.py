...
class BPMsplModel():
    ...
    def BPMsplModel_TBLTE(self):
        ...
        # boundaryP = csdl.expand(delta_P, target_shape, 'ij -> iajc')   #This part should not be defined as 'csdl.variable' since they are value defined from 'main' function
        ...
        def BPMsplModel_LBLVS():
            ...
            #==================== Computing St (Strouhal numbers) ====================
            St_prime = (f * boundary_thickP)*(u + 1e-7)   # note : a for boundaryS instead of a_star
